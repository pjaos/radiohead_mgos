...
## Description
A RadioHead broadcast message is sent using a radio attached to a serial port using Mongoose OS. This should be used along with another device running the [serial_rx_broadcast](../rx_broadcast/README.md) example.
