...
## Description
A RadioHead message is sent (from this client) using a radio attached to a serial port using Mongoose OS. This should be used along with another device running the [serial_server](../server/README.md) example.
