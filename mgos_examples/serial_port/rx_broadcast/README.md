...
## Description
A RadioHead broadcast message is received using a radio attached to a serial port using Mongoose OS. This should be used along with another device running the [serial_tx_broadcast](../tx_broadcast/README.md) example.
